...
*Опция 1:*
1. Выберите 2-3 датасета одной тематики для анализа. Следите, чтобы датасет содержал **не синтетические данные**.
...
3. Каждая визуализация-проверка должна содержать вывод: что наблюдаем, подтвердилась ли гипотеза. При выполнении работы используйте не менее двух разных библиотек для визуализации (не в рамках одной гипотезы, а в целом во всей работе).
